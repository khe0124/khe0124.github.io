...
export const description =
  "5년 이상 프론트엔드를 개발하며, 복잡한 산업 도메인을 사용 가능한 제품 UI로 바꾸는 일을 해왔습니다. LCA/LCCI, 탄소 크레딧, Web3, IoT, STO처럼 개념 자체가 어려운 영역에서 입력·검증·시각화·리포트·운영 화면까지 연결되는 화면 구조를 설계하고 구현해왔고, 단순한 화면 제작보다 실제 업무 흐름이 동작하는 제품을 만드는 데 강점이 있습니다."
